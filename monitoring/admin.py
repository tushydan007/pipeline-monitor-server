...
class PipelineAdmin(GISModelAdmin):
    ...
    fieldsets = (
        ...
        (
            "Route Coordinates Entry",
            {
                "fields": ("manual_coordinates", "geojson_file"),
                "description": "Enter pipeline route coordinates manually OR upload a GeoJSON file. Manual entry takes precedence if both are provided. Manual format: [[lon1, lat1], [lon2, lat2], ...] or one per line: lon1,lat1\\nlon2,lat2",
                "classes": ("wide",),
            },
        ),
        (
