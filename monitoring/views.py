...
from .serializers import (
    PipelineSerializer, SatelliteImageSerializer, AnalysisResultSerializer,
    MonitoringAlertSerializer, PipelineSegmentSerializer,
    MonitoringConfigurationSerializer, DashboardStatsSerializer,
...
class PipelineViewSet(viewsets.ModelViewSet):
    ...
    def recent_images(self, request, pk=None):
        ...
        images = pipeline.satellite_images.filter(
            image_date__gte=since
        ).order_by('-image_date')
    ...
    def analysis_summary(self, request, pk=None):
        ...
        summary = {
            ...
            'leak_detections': analysis_results.filter(analysis_type='leak_detection').count(),
...
class DashboardViewSet(viewsets.ViewSet):
    ...
    def stats(self, request):
        ...
        # Last analysis date
        last_analysis = AnalysisResult.objects.aggregate(
    ...
    def pipeline_health(self, request):
        ...
        for pipeline in pipelines:
            ...
            health_data.append({
                ...
                'last_analysis': recent_results.first().created_at if recent_results.exists() else None,
            })
