...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'pipeline_monitoring'),
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'noreply@pipeline-monitoring.com')
...
# # SECURITY WARNING: keep the secret key used in production secret!
# SECRET_KEY = 'django-insecure-9l&@pn9y!tay($%is(t2=e@3u(1$^_d+x!z=fywc@^$#op^!&u'
